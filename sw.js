/* SÜKÛN r811 — Berhetiyye Counter Ring + Update Recovery
...
const SURUM = 'r811';
const CACHE = 'sukun-r811-20260914j';
const CACHE_META = './__sukun_cache_meta_r811__.json';
const BUILD_MARKER = './__sukun_build_r811__.json';
...
const PRECACHE = [
  ...
  './assets/berhetiyye-premium/berhetiyye-ring-r811.png',
...
const NOTLAR = [
  ...
  'Yeni berhetiyye-ring-r811.png best-effort pre-cache edilir; install tek görsel hatası yüzünden kilitlenmez.',
