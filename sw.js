/* SÜKÛN r812 — Berhetiyye Counter Ring + Update Recovery
...
const SURUM = 'r812';
const CACHE = 'sukun-r812-20260914k';
const CACHE_META = './__sukun_cache_meta_r812__.json';
const BUILD_MARKER = './__sukun_build_r812__.json';
...
const PRECACHE = [
  ...
  './assets/berhetiyye-premium/berhetiyye-ring-r812.png',
...
const NOTLAR = [
  ...
  'Yeni berhetiyye-ring-r812.png best-effort pre-cache edilir; install tek görsel hatası yüzünden kilitlenmez.',
