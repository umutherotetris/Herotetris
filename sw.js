/* SÜKÛN r819 — Berhetiyye Counter Ring + Update Recovery
...
const SURUM = 'r819';
const CACHE = 'sukun-r819-20260914a';
const CACHE_META = './__sukun_cache_meta_r819__.json';
const BUILD_MARKER = './__sukun_build_r819__.json';
