...
.tv-game{ flex:1; display:flex; flex-direction:column; padding:6px 8px 4px; max-width:640px; margin:0 auto; width:100%; box-sizing:border-box; height:100%; max-height:100svh; overflow:hidden; }
...
.tg-controls{ display:flex; gap:6px; justify-content:center; align-items:center; padding:5px 0 3px; flex-shrink:0; }
.tg-actions{ display:flex; gap:6px; justify-content:center; align-items:center; padding:0 0 4px; flex-shrink:0; flex-wrap:wrap; }
