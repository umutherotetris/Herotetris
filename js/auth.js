...
const { getDatabase, ref, get, set, update, onValue, push, remove } = await import(`${BASE}/firebase-database.js`);
...
export const fdb = { ref, get, set, update, onValue, push, remove };
