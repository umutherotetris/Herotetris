  ...
  function openPanel(){
    ...
    panel.innerHTML = `
      ...
      <div class="ghp-cc-body">
        ...
        ${api.onTheme ? `<button class="ghp-cc-guide-btn" style="margin-top:5px" data-cc="theme">🎨 Tahta Teması</button>` : ''}
    ...
    const tb = panel.querySelector('[data-cc="theme"]');
    if(tb) tb.addEventListener('click', () => { closePanel(); try{ api.onTheme(); }catch(e){} });
  }
