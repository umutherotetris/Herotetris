...
function bindTouchGestures(){
  ...
  const onEnd = (e) => {
    ...
    // Hızlı aşağı swipe → sert bırak (kısa sürede büyük dikey hareket, yatay küçük)
    if(totalDY > cell * 2.5 && dt < 250 && movedH < movedV){
      hardDrop();
      return;
    }
...
/* Tahta */
.tetris-board-wrap{ flex: 1; display: flex; align-items: flex-start; justify-content: center; position: relative; min-width: 0; min-height: 0; overflow: hidden; touch-action: none; -webkit-user-select: none; user-select: none; -webkit-touch-callout: none; cursor: pointer; }
